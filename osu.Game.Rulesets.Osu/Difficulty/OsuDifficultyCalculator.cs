...
namespace osu.Game.Rulesets.Osu.Difficulty
{
    ...
    {
        private static double performance_base_multiplier => 1.15; // This is being adjusted to keep the final pp value scaled around what it used to be when changing things.
