...
{
    public class Reaction : HarmonicSkill
    {
        ...
        public Reaction(IBeatmap beatmap, Mod[] mods, double clockRate)
            : base(mods)
        {
        ...
        protected override double ObjectDifficultyOf(DifficultyHitObject current)
        {
            ...
            currentDifficulty += ReadingEvaluator.EvaluateDifficultyOf(current, objectList.Count, clockRate, preempt, hasHiddenMod).preemptDifficulty * skillMultiplier;
